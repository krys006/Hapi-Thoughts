...
urlpatterns = [
    ...
    path("register/pending/", views.owner_register_pending, name="owner_register_pending"),
    path("verify-email/<uidb64>/<token>/", views.owner_verify_email, name="owner_verify_email"),
